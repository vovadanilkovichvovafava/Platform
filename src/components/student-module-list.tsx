      ...
      {enrollments.map((enrollment) => {
        ...
        return (
          <Card key={enrollment.trailId}>
            <Collapsible defaultOpen={trailModules.length <= 10}>
              <CardContent className="p-0">
                {/* Collapsible Header */}
                <CollapsibleTrigger className="w-full p-4 hover:bg-gray-50 rounded-t-lg transition-colors" showChevron={false}>
                  ...
                  <div className="px-4 pb-4 pt-2 border-t">
                    ...
                    <div className="flex items-center gap-4 mb-3 text-xs text-gray-500">
                      <span className="flex items-center gap-1">
                        ...
                        {completedModules.length} завершено
                      </span>
