...
- Пиши КОРОТКО и ЖИВО. Максимум 1-2 предложения на вопрос. Никаких длинных вступлений.
...
<examples>
ХОРОШИЙ вопрос (короткий, живой):
"Почему ты выбрал именно эту библиотеку? Что было бы, если данных в 10 раз больше?"

ХОРОШИЙ вопрос (прямой):
"Что сломается в твоём решении, если сервер будет отвечать медленно?"

ХОРОШИЙ вопрос (практичный):
...
→ Лучше: "Что изменишь в решении, если добавить ограничение Y?"
...
→ Лучше: "Почему выбрал такую структуру проекта?"
...
5. Вопрос длиннее 2 предложений? → СОКРАТИ.
...
Отвечай СТРОГО валидным JSON — без markdown, без пояснительного текста вокруг JSON.
{
  ...
  "questions": [
    {
      "question": "текст вопроса (1-2 предложения, простой язык)",
...
- От 5 до 8 вопросов.
- Каждый вопрос — максимум 1-2 коротких предложения.
