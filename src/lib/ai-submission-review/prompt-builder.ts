...
Если работа студента полностью покрывает все аспекты модуля с глубоким пониманием — верни status "FULLY_COVERED" и 3-5 вопросов на углубление: смежные аспекты, перенос знаний в другой контекст, оценку ограничений решения. НЕ повторяй то, что студент уже написал.
</examples>
...
- От 5 до 8 вопросов.
- Если работа полностью покрывает все аспекты: status "FULLY_COVERED", 3-5 вопросов на углубление и смежные аспекты (но НЕ повторяй уже отвеченное в работе).
