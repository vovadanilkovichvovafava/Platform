...
export const adminHelpHints = {
  ...
  studentAccess: {
    ...
    grantAccess: {
      shortHint:
        "Назначайте ограниченные трейлы студентам через карточки. Изменения сохраняются по кнопке.",
    },
    revokeAccess: {
      shortHint:
    ...
    sections: [
      {
        title: "Что это",
        description:
          "Назначение ограниченных трейлов конкретным студентам. Каждый студент — карточка с тегами назначенных трейлов.",
      },
      {
        title: "Как назначать",
        description:
          "Нажмите «Назначить трейл» на карточке студента и выберите трейл из списка. Изменения не применяются сразу — нажмите «Сохранить».",
        details: [
          "Зелёные пунктирные теги — ожидают сохранения (новые)",
          "Зачёркнутые красные теги — ожидают удаления",
          "Кнопка «Отменить» сбрасывает все несохранённые изменения",
        ],
      },
      {
        title: "Какие трейлы доступны",
        description:
          "В списке отображаются только ограниченные и опубликованные трейлы. Управление статусами трейлов — во вкладке «Доступ трейлов».",
      },
    ],
  },
  trailSettings: {
    heading: "Как работает доступ трейлов",
    sections: [
      {
        title: "Что это",
        description:
      ...
      },
      {
        ...
        description:
          "Trail исчезнет для всех студентов, кроме тех, кому вы явно дали доступ через вкладку «Доступ студентов». Прогресс существующих студентов сохраняется.",
      },
    ],
  },
  adminAccess: {
