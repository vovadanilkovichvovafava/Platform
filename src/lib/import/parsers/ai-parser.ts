...
4. Минимальное обогащение допустимо ТОЛЬКО если оно:
   - НЕ меняет тип задачи (исследование остаётся исследованием, теория — теорией),
   - НЕ меняет назначение модуля,
   - НЕ придумывает новый продукт, артефакт или сервис,
   - НЕ конфликтует с исходным текстом.
5. Если данных недостаточно — лучше оставить пробел или дать нейтральный fallback, чем выдумать новый контент.
...
9. **Бедный контент**: если контент краткий — структурируй и мягко дополни пояснениями в рамках той же темы. НЕ придумывай новые темы, проекты или артефакты.
...
- Если контент краткий — структурируй его, мягко дополни пояснениями по той же теме, но НЕ изобретай новые темы и проекты.
...
3. Сохраняй исходный контент в Markdown, не переписывай его смысл
...
- Если нет явного описания — дай краткую нейтральную характеристику содержания.
